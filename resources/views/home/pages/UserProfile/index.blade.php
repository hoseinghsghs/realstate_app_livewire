                            ...
                            <div class="frm_submit_block">
                                ...
                                <div class="frm_submit_wrap">
                                    ...
                                    <div class="form-row">
                                        ...
                                        <label class="mt-3 mr-3">@error('name')
                                        ...
                                        <label class="mt-3 mr-3">@error('email')
                                            <div style="color: red;margin-top: -18px;">{{$message}}</div>
                                            @enderror
                                        </label>
                                        ...
                                        <label class="mt-3 mr-3">@error('phone')
                                            <div style="color: red;margin-top: -18px;">{{$message}}</div>
                                            @enderror
                                        </label>
                                        ...
                                        <label class="mt-3 mr-3">@error('about')
                                            <div style="color: red;margin-top: -18px;">{{$message}}</div>
                                            @enderror
                                        </label>
                                ...
                                <div class="frm_submit_wrap">
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-lg-12 col-md-12 mt-4">
                                            <button class="btn btn-theme btn-lg" type="submit">ذخیره تغییرات</button>
                                        </div>
