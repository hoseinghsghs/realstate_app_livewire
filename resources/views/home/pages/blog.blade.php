            ...
            <div class="col-lg-4 col-md-6">
                <div class="grid_blog_box">
                    <div class="gtid_blog_thumb">
                        <a href="{{route('blog.show', $post->id)}}}"><img src="{{asset('storage/'.$post->image->url)}}" class="img-fluid" alt="{{$post->slug}}" /></a>
                    ...
                    <div class="blog-body">
                        <h4 class="bl-title"><a href="{{route('blog.show', $post->id)}}">{{$post->title}}</a><span class="latest_new_post">خبر</span></h4>
                    ...
                    <div class="modern_property_footer">
                        <div class="property-author">
                            <div class="path-img"><a tabindex="-1"><img src="{{asset('storage/profile/'.$post->user->image)}}" class="img-fluid" alt=""></a></div>
                            <h5><a tabindex="-1">{{$post->user->name}}</a></h5>
                        </div>
                        <span class="article-pulish-date"><div class="footer-flex">
