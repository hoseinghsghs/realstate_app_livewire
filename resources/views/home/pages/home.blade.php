        ...
        <div class="row justify-content-center mt-4">
            ...
            <div class="col-lg-3 col-md-4 col-sm-6">
                <div class="_category_box">
                    <a href="{{route('properties.list',['type'=>'آپارتمان'])}}">
            ...
            <div class="col-lg-4 col-md-6 col-sm-12">
                <div class="property-listing property-2">
                    ...
                    <div class="listing-img-wrapper">
                        @isset($property_rents->lable)<div class="_exlio_125" style="background-color:#ff2f2f;">
                            {{$property_rents->lable}}</div>@endisset
                    ...
                    <div class="listing-detail-wrapper">
                        <div class="listing-short-detail-wrap">
                            <div class="_card_list_flex mb-2">
                                ...
                                <a id="{{$property_rents->id}}" onclick="return send('{{$property_rents->id}}')"
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-lg-4 col-md-6 col-sm-12">
                <div class="property-listing property-2">
                    ...
                    <div class="listing-img-wrapper">
                        @isset($property_sell->lable)<div class="_exlio_125" style="background-color:#ff2f2f;">
                            {{$property_sell->lable}}</div>@endisset
                        <div class="list-img-slide">
                            <div class="click">
                    ...
                    <div class="listing-detail-wrapper">
                        <div class="listing-short-detail-wrap">
                            <div class="_card_list_flex mb-2">
                                ...
                                <a id="{{$property_sell->id}}" onclick="return send('{{$property_sell->id}}')"
                                    style="color:red;font-size: 24px;" class="geodir_save-btn tolt"
                                    data-microtip-position="left" data-tooltip="ذخیره"><span><i
                                            class="ti-heart"></i></span></a>
                    ...
                    <div class="listing-detail-footer">
                        ...
                        <div class="footer-flex">
                            <a href={{route('properties.show',[$property_sell->id])}} class="prt-view">مشاهده جزئیات</a>
                        </div>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="grid_blog_box">
                    ...
                    <div class="gtid_blog_thumb">
                        <a href="{{route('blog.show', $post->id)}}"><img src="{{asset('storage/'.$post->image->url)}}"
                                class="img-fluid" alt="{{$post->slug}}" /></a>
                    ...
                    <div class="blog-body">
                        <h4 class="bl-title"><a href="{{route('blog.show', $post->id)}}">{{$post->title}}</a><span
                    ...
                    <div class="modern_property_footer">
                        <div class="property-author">
                            <div class="path-img"><a tabindex="-1"><img
                                        src="{{asset('storage/profile/'.$post->user->image)}}" class="img-fluid"
                                        alt=""></a>
                            </div>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="grid_blog_box">
                    ...
                    <div class="modern_property_footer">
                        <div class="property-author">
                            <div class="path-img"><a tabindex="-1"><img
                                        src="{{asset('storage/profile/'.$article->user->image)}}" class="img-fluid"
                                        alt=""></a>
                            </div>
