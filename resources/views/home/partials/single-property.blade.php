<div class="col-lg-6 col-md-6 col-sm-12">
    <div class="property-listing property-2">
        ...
        <div class="listing-img-wrapper">
            @isset($property->lable)<div class="_exlio_125" style="background-color:#ff2f2f;">{{$property->lable}}</div>
            @endisset
            ...
            <div class="listing-short-detail-wrap">
                <div class="_card_list_flex mb-2">
                    ...
                    <a id="{{$property->id}}" onclick="return send('{{$property->id}}')"
                        style="color:red;font-size: 24px;" class="geodir_save-btn tolt" data-microtip-position="left"
                        data-tooltip="ذخیره"><span><i class="ti-heart"></i></span></a>

                    @elseif ($property->checkUserWishlist(auth()->id()))
                    <a id="{{$property->id}}" onclick="return send('{{$property->id}}')"
                        style="color:blue ;font-size: 24px;" class="geodir_save-btn tolt" data-microtip-position="left"
                        data-tooltip="ذخیره"><span><i class="ti-heart"></i></span></a>
                        ...
                        <h4 class="listing-name verified">
                            <a href="{{route('properties.show',[$property->id])}}" class="prt-link-detail">
                                <h6 class="listing-card-info-price mb-2 numbers" style="font-size: 15px;">
                                    مبلغ
                                    :
                                    {{number_format($property->bidprice)}}
                                    تومان
                                </h6>
                            </a>
                        </h4>
