                ...
                <div class="_prtis_list mb-4">
                    ...
                    <div class="_prtis_list_body">
                        <ul class="deatil_features">
                            @isset($property->code)
                                <li><strong>{{ $property->code }}</strong>شناسه ملک</li>
                            @endisset
                            @isset($property->floor)
                                <li><strong>{{ $property->floor }}</strong>تعداد طبقات
                                </li>
                            @endisset
                            @isset($property->year)
                                <li><strong>{{ $property->year }}</strong>مدت ساخت</li>
                            @endisset
                            @isset($property->area)
                                <li><strong>{{ $property->area }}</strong>مساحت زمین ملک
                                </li>
                            @endisset
                            @if ($property->tr_type === 'رهن و اجاره')
                                @isset($property->people_number)
                                    <li>
                            ...
                            @else
                                @isset($property->loan)
                                    <li><strong>{{ $property->loan }}</strong>وام بانکی
                                    </li>
                                @endisset
                            ...
                            @endif
                            @isset($property->doc)
                                <li><strong>{{ $property->doc }}</strong>نوع سند
                                </li>
                            @endisset
                            @isset($property->dimension)
                                <li>
                                    <strong>{{ $property->dimension }}</strong>ابعاد
                                </li>
                            @endisset
                            @isset($property->view)
                                <li><strong>{{ $property->view }}</strong>نما</li>
                            @endisset
                            @isset($property->door)
                                <li><strong>{{ $property->door }}</strong>درب ورودی
                                </li>
                            @endisset
                            @isset($property->screen)
                                <li><strong>{{ $property->screen }}</strong>پرده
                                </li>
                            @endisset
                            @isset($property->cover)
                                <li><strong>{{ $property->cover }}</strong>کفپوش
                                </li>
                            @endisset
                            @isset($property->phone_line)
                                <li><strong>{{ $property->phone_line }}</strong>خط
                                    تلفن
                                </li>
                            @endisset
                            @isset($property->cool)
                                <li><strong>{{ $property->cool }}</strong>سیستم
                                    برودتی
                                </li>
                            @endisset
                            @isset($property->heat)
                                <li><strong>{{ $property->heat }}</strong>سیستم
                                    حرارتی
                                </li>
                            @endisset
                            @isset($property->cabinet)
                                <li><strong>{{ $property->cabinet }}</strong>کابینت
                                </li>
                            @endisset
