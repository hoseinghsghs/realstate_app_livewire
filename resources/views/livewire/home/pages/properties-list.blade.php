                            ...
                            <div class="form-group">
                                <div class="input-with-icon">
                                    <input wire:model.live.debounce.600="filter.search" type="text"
                                        class="form-control" placeholder="عنوان، آدرس">
                                    <i class="ti-search"></i>
                                </div>
                            </div>
                                    ...
                                    <div class="form-group">
                                        <div class="simple-input">
                                            <input wire:model.live.debounce.600="filter.code" type="text"
                                                class="form-control" placeholder="شناسه ملک">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-lg-12 col-md-12 col-sm-12 pt-4 pb-4">
                                    ...
                                    <div class="rg-slider" wire:ignore>
                                        <input type="text" class="floor-range-slider" name="floor-range"
                                            value="" />
                                    </div>
                                </div>
                                <div class="col-lg-12 col-md-12 col-sm-12 pt-4 pb-4">
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12 pt-4 pb-4">
                                    <h6>متراژ(مترمربع)</h6>
                                    <div class="rg-slider" wire:ignore>
                                        <input type="text" class="meter-range-slider" name="meter-range"
                                            value="" />
                                    </div>
                                </div>
                                <div id="price" @class([
                                    'col-lg-12 col-md-12 col-sm-12 pt-4 pb-4',
                                    'd-none' => $filter['deal_type'] === 'رهن و اجاره' || !$filter['deal_type'],
                                ])>
                                    <h6>قیمت(تومان)</h6>
                                    <div class="rg-slider" wire:ignore>
                                ...
                                <div id="rahn" @class([
                                    'col-lg-12 col-md-12 col-sm-12 pt-4 pb-4',
                                    'd-none' => $filter['deal_type'] === 'فروش' || !$filter['deal_type'],
                                ])>
                                    <h6>رهن(تومان)</h6>
                                    <div class="rg-slider" wire:ignore>
                                            ...
                                            @foreach ($all_features as $feature)
                                                <li class="col-lg-6 col-md-6 p-0">
                                                    <input id="check-{{ $feature->id }}" class="checkbox-custom"
                                                        value="{{ $feature->id }}" wire:model.live="filter.features"
                                                        type="checkbox">
