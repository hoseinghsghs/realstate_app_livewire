                                                ...
                                                <div class="body">
                                                                ...
                                                                @foreach (range(1, max(1, (int) $form->floor)) as $floor)
                                                                    <div class="form-check form-check-inline m-1">
                                                                        <input class="form-check-input"
                                                                            ...
                                                                            value="{{ $floor }}">
                                                                        <label
                                                                            class="form-check-label text-primary mr-4"
                                                    ...
                                                    <div class="row clearfix">
                                                        <div class="form-group col-md-4">
                                                            ...
                                                            <input wire:model="form.otherimg" type="file"
                                                                id="imageUpload" lang="ar" dir="rtl"
                                                                multiple>
                                                            <label class="custom-file-label text-right"
                                                                for="customFile">
                                                            </label>
                                                            <small class="text-danger" id="validation-errors"></small>
                                                        </div>
                                                    </div>
