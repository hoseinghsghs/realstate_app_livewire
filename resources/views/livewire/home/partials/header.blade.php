                ...
                <nav id="navigation" class="navigation navigation-landscape">
                    ...
                    <div class="nav-menus-wrapper" style="transition-property: none;">
                        <ul class="nav-menu">
                            ...
                            <li @class(['active' => request()->routeIs('home')])><a href="/" wire:navigate>خانه</a></li>
                            <li @class([
                                'active' =>
                                    request()->routeIs('properties.list') &&
                                    empty(request()->has('deal_type')),
                            ])>
                            ...
                            <li @class([
                                'active' =>
                                    request()->routeIs('properties.list') &&
                                    request()->get('deal_type') == 'رهن و اجاره',
                            ])>
                                <a href="{{ route('properties.list', ['deal_type' => 'رهن و اجاره']) }}"
                                    wire:navigate>رهن
                                    و
                                    اجاره
                            ...
                            <li @class([
                                'active' =>
                                    request()->routeIs('properties.list') &&
                                    request()->get('deal_type') == 'فروش',
                            ])>
                                <a href="{{ route('properties.list', ['deal_type' => 'فروش']) }}"
                                    wire:navigate>فروش<span class="submenu-indicator"></span></a>
                            </li>
                            <li @class(['active' => url()->current() == route('blog.index')])><a href={{ route('blog.index') }} wire:navigate>اخبار</a>
                            </li>

                            <li @class(['active' => url()->current() == route('articles.index')])><a href={{ route('articles.index') }}
                                    wire:navigate>مقالات</a>
                            </li>

                            <li @class(['active' => url()->current() == route('contact_us')])><a href={{ route('contact_us') }} wire:navigate>تماس با
                                    ما</a></li>
                        </ul>
                            ...
                            @auth
                                @can('is_admin')
                                    ...
                                    <li class="add-listing">
                                        <a href="/admin/dashboard" target="_blank" class="theme-cl">
                                ...
                                @can('is_agent')
                                    <li class="_my_prt_list"><a href="/logout" wire:navigate>خروج</a></li>
                                    <li class="add-listing">
                                        <a href="/agent/dashboard" target="_blank" class="theme-cl">
                                            <i class="fa fa-user ml-1"></i>داشبورد
                                        </a>
                                    </li>
                                @endcan
