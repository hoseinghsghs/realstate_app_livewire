                                    ...
                                    <div class="body">
                                                ...
                                                <div class="form-group">
                                                    <select name="lable" id="lable"
                                                        ...
                                                        <option {{ old('lable')== 'فروخته شد' ? 'selected' : ""}}>
                                                            فروخته شد</option>
                                                        <option {{ old('lable')== 'اجاره داده شد' ? 'selected' : ""}}>
                                        ...
                                        <div class="row clearfix">
                                            <div class="col-lg-4 col-md-6">
                                                ...
                                                <div class="form-group">
                                                    <select name="tr_type" onchange="settype()" id="tr_type" required
                                                        class="form-control show-tick ms select2">
                                                        <option disabled selected hidden>
                                                        </option>
                                                        <option {{ old('tr_type')== 'رهن و اجاره' ? 'selected' : ""}}>
                                                            رهن و
                                                            اجاره
                                                        </option>
                                                        <option {{ old('tr_type')== 'فروش' ? 'selected' : ""}}>فروش
                                                        </option>
                                                       <option {{ old('tr_type')== 'پیش فروش' ? 'selected' : ""}}>پیش فروش
                                                        </option>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="col-lg-4 col-md-6">
                                                ...
                                                <div class="form-group">
                                                    <select name="usertype" id="usertype"
                                                        class="form-control show-tick ms select2">
                                                        <option disabled selected hidden></option>
                                                        <option {{ old('usertype')== 'مسکونی' ? 'selected' : ""}}>مسکونی
                                                        </option>
                                                        <option {{ old('usertype')== 'تجاری' ? 'selected' : ""}}>تجاری
                                                        </option>
                                                        <option {{ old('usertype')== 'آموزشی' ? 'selected' : ""}}>آموزشی
                                                        </option>
                                                        <option {{ old('usertype')== 'اداری' ? 'selected' : ""}}>اداری
                                                        </option>
                                                        <option {{ old('usertype')== 'باغ ویلا' ? 'selected' : ""}}>باغ ویلا
                                                        </option>
                                                        <option {{ old('usertype')== 'دیگر' ? 'selected' : ""}}>دیگر
                                                        </option>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="col-lg-4 col-md-6">
                                                ...
                                                <div class="form-group">
                                                    <select name="type" id="type" required
                                                        class="form-control show-tick ms select2">
                                                        <option disabled selected hidden></option>
                                                        <option {{ old('type')== 'آپارتمان' ? 'selected' : ""}}>آپارتمان
                                                        </option>
                                                        <option {{ old('type')== 'خانه ویلایی' ? 'selected' : ""}}>خانه
                                                            ویلایی
                                                        </option>
                                                        <option {{ old('type')== 'زمین و کلنگی' ? 'selected' : ""}}>زمین
                                                            و
                                                            کلنگی
                                                        </option>
                                                        <option {{ old('type')== 'مغازه' ? 'selected' : ""}}>مغازه
                                                        </option>
                                                        <option {{ old('type')== 'دفتر کار' ? 'selected' : ""}}>دفتر کار
                                                        </option>
                                                        <option {{ old('type')== 'باغ' ? 'selected' : ""}}>باغ</option>
                                                        <option {{ old('type')== 'انبار' ? 'selected' : ""}}>انبار
                                                        </option>
                                                    </select>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row clearfix">
                                            <div class="col-lg-4">
                                                ...
                                                <div class="form-group">
                                                    <input type="number" id="bedroom" name="bedroom" step="1"
                                                        aria-disabled class="form-control" value="{{old('bedroom')}}"
                                                        required />
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-sm-4">
                                                ...
                                                <div class="form-group">
                                                    <input type="number" id="meter" name="meter"
                                                        value="{{old('meter')}}" max="10000" class="form-control" required />
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row clearfix ir-select">
                                            <div class="col-sm-4">
                                             ...
                                             <select value="{{old('province')}}"
                                                    class="ir-province  form-control show-tick ms select2" id="province"
                                            ...
                                            <div class="col-sm-4">
                                                ...
                                                <div class="form-group">
                                                   <select value="{{old('city')}}"
                                                        class="ir-city  form-control show-tick ms select2" name="city"
                                            ...
                                            <div class="col-sm-4">
                                                ...
                                                <div class="form-group">
                                                    <input type="text" step="any" name="district" id="district"
                                                        class="form-control" value="{{old('district')}}" required />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row clearfix">
                                            ...
                                            <div class="col-sm-6">
                                                ...
                                                <div class="form-group">
                                                    <input type="number" value="{{old('lon')}}" step="any" id="lon"
                                            ...
                                            <div class="col-sm-6">
                                                ...
                                                <div class="form-group">
                                                    <input type="number" value="{{old('lon')}}" step="any" name="lat"
                                                ...
                                                <div class="form-group">
                                                    <div class="file-loading">
                                                        <input id="input-21" data-overwrite-initial="true"
                                                            name="otherimg[]" multiple type="file" data-theme="fas">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                      ...
                                      <div class="header">
                                         ...
                                         <div class="row clearfix">
                                            <div class="col-sm-12">
                                                ...
                                                <div class="form-group">
                                                    <input type="text" value="{{old('ambed')}}" id="ambed" name="ambed"
                                                        class="form-control" />
                                                </div>
                                            </div>
                                        </div>
                                      <br>
                                        ...
                                        <div class="row clearfix">
                                            <div class="col-sm-4">
                                                ...
                                                <div class="form-group">
                                                    <input type="text" value="{{old('loan')}}" id="loan" name="loan"
                                                        class="form-control" />
                                                </div>
                                            </div>
                                            <div class="col-sm-4">
                                                ...
                                                <div class="form-group">
                                                    <div class="input-group mb-3">
                                                        ...
                                                        <input type="text" value="{{old('meter_price')}}"
                                                            ...
                                                            onkeyup="separateNum(this.value,this);" name="meter_price"
                                                            aria-label="Amount (to the nearest dollar)">
                                                        <div class="input-group-append">
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="row clearfix">
                                            <div class="col-lg-3 col-md-6">
                                                ...
                                                <div class="form-group">
                                                    <input type="number" id="people_number" name="people_number"
                                                        value="{{old('people_number')}}" class="form-control" />
                                                </div>
                                            </div>
                                            <div class="col-lg-3 col-md-6">
                                                ...
                                                <div class="form-group">
                                                    <div class="input-group mb-3">
                                                        ...
                                                        <input type="text" value="{{old('rent')}}" class="form-control"
                                                            id="rent" name="rent"
                                                            aria-label="Amount (to the nearest dollar)"
                                            ...
                                            <div class="col-lg-3 col-md-6">
                                                ...
                                                <div class="form-group">
                                                    <div class="input-group mb-3">
                                                        ...
                                                        <input type="text" value="{{old('rahn')}}" class="form-control"
                                                            id="rahn" name="rahn"
                                                            aria-label="Amount (to the nearest dollar)"
                                            ...
                                            <div class="col-lg-3 col-md-6">
                                                <br><br>
                                                <div class="checkbox">
                                                    <input id="cheng" {{ old('ischenge') ==='on' ? 'checked' : '' }}
                                    ...
                                    <div class="body">
                                        <div class="row clearfix">
                                            <div class="col-lg-3">
                                                ...
                                                <div class="form-group">
                                                    <select name="doc" id="doc"
                                                        class="form-control show-tick ms select2">
                                                        <option disabled selected hidden></option>
                                                        <option {{ old('doc')== 'سند دار' ? 'selected' : ""}}>سند دار
                                                        </option>
                                                        <option {{ old('doc')== 'قولنامه ای' ? 'selected' : ""}}>قولنامه ای
                                                        </option>
                                                        <option {{ old('doc')== 'در دست اقدام' ? 'selected' : ""}}>در دست اقدام
                                                        </option>
                                            ...
                                            <div class="col-lg-3">
                                                ...
                                                <div class="form-group">
                                                    <input type="text" id="dimension" value="{{old('dimension')}}"
                                            ...
                                            <div class="col-lg-3">
                                                ...
                                                <div class="form-group">
                                                    <input type="text" value="{{old('view')}}" id="view" name="view"
                                                        class="form-control" />
                                                </div>
                                            </div>
                                            <div class="col-lg-3">
                                                ...
                                                <div class="form-group">
                                                    <input type="text" value="{{old('door')}}" id="door" name="door"
                                                        class="form-control" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row clearfix">
                                            <div class="col-sm-4">
                                                ...
                                                <div class="form-group">
                                                    <input type="text" value="{{old('screen')}}" id="screen"
                                            ...
                                            <div class="col-sm-4">
                                                ...
                                                <div class="form-group">
                                                    <input type="text" value="{{old('cover')}}" id="cover" name="cover"
                                                        class="form-control" />
                                                </div>
                                            </div>
                                            <div class="col-sm-4">
                                                ...
                                                <div class="form-group">
                                                    <input type="text" value="{{old('phone_line')}}" id="phone_line"
                                        ...
                                        <div class="row clearfix">
                                            <div class="col-sm-4">
                                                ...
                                                <div class="form-group">
                                                    <input type="text" value="{{old('cool')}}" id="cool" name="cool"
                                                        class="form-control" />
                                                </div>
                                            </div>
                                            <div class="col-sm-4">
                                                ...
                                                <div class="form-group">
                                                    <input type="text" value="{{old('heat')}}" id="heat" name="heat"
                                                        class="form-control" />
                                                </div>
                                            </div>
                                          <div class="col-sm-4">
                                                ...
                                                <div class="form-group">
                                                    <input type="text" value="{{old('cabinet')}}" id="cabinet" name="cabinet"
                                                        class="form-control" />
                                                </div>
                                            </div>
                                            <div class="col-lg-4">
                                                ...
                                                <div class="form-group">
                                                    <input type="number" value="{{old('collection')}}" id="collection"
