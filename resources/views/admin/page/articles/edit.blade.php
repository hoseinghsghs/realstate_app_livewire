                ...
                <div class="col-lg-7 col-md-6 col-sm-12">
                    ...
                    <ul class="breadcrumb">
                        <li class="breadcrumb-item"><a href={{route('admin.home')}}><i class="zmdi zmdi-home"></i>
                                خانه</a></li>
                        <li class="breadcrumb-item"><a href="javascript:void(0);">مقاله</a></li>
                        <li class="breadcrumb-item active">تغییر مقاله</li>
                    </ul>
                                ...
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        ...
                                        <input type="text" name="title" class="form-control" maxlength="100"
                                            minlength="3" value="{{old('title')??$article->title}}" required>
                                    </div>
                                </div>
