            ...
            <div class="row">
                <div class="col-lg-7 col-md-6 col-sm-12">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">تغییر اسلایدر</li>
                    </ul>
                                ...
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        ...
                                        <input type="text" name="title" class="form-control" maxlength="30"
                                            minlength="3" value="{{old('title')??$slider->title}}" required>
                                    </div>
                                </div>
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        ...
                                        <select name="position" class="form-control show-tick ms select2" required>
                                            <option {{ $slider->position=='اسلایدر' ? 'selected' : '' }}>اسلایدر
                                            </option>
                                            <option {{ $slider->position=='بنر' ? 'selected' : '' }}>بنر</option>
                                            <option {{ $slider->position=='تصویرسرویس' ? 'selected' : '' }}>تصویرسرویس
                                            </option>
                                ...
                                <div class="form-group ">
                                    ...
                                    <div class="col-lg-6 px-0">
                                        <input type="file" name="image" class="dropify"
                                            ...
                                            data-default-file="{{asset('storage/slider/'.$slider->image)}}">
                                    </div>
                                </div>
